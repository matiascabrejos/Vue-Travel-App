            ...
            <div class="lg:pt-12 pt-6 w-full md:w-4/12 px-4 text-center">
              ...
              >
                <div class="px-4 py-5 flex-auto">
                  ...
                  <h6 class="text-2xl font-bold text-gray-900">Tell us the basics</h6>
            ...
            <div class="w-full md:w-4/12 px-4 text-center">
              ...
              >
                <div class="px-4 py-5 flex-auto">
                  ...
                  <h6 class="text-2xl font-bold text-gray-900">Take photos of the space</h6>
                  <p class="mt-2 mb-4 text-gray-900 font-semibold">
            ...
            <div class="pt-6 w-full md:w-4/12 px-4 text-center">
              ...
              >
                <div class="px-4 py-5 flex-auto">
                  ...
                  <h6 class="text-2xl font-bold text-gray-900">Highlight unique details</h6>
                  <p class="mt-2 mb-4 text-gray-900 font-semibold">
